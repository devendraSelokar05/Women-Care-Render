...
const { addToCart, removeFromCart, BuyOrderFromCart, incrementCartItem, decrementCartItem, saveForLater, moveToCart,  getCartItemCount, getCart } = require("../../controllers/UserControllers/cartController");


//✅ User Cart Routes
router.post("/addtocart/:productId",userValidateToken,addToCart);
router.get("/getCarts", userValidateToken, getCart);
router.get("/getCartItemCount", userValidateToken,   getCartItemCount,)
